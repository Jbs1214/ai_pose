...
class _DeadliftAnalysisPageState extends State<DeadliftAnalysisPage> {
  ...
  int kneeTooStraightCount = 0;
  int kneeTooBentCount = 0;
  int hipForwardCount = 0;
  int hipBackwardCount = 0;
  int goodCount = 0;
  ...
  Future<void> _onStopPressed() async {
    ...
    final prompt = "운동: 데드리프트. 총 ${_deadliftDataList.length} 프레임의 데이터가 수집되었습니다.\n"
        "$summary\n"
